...
class ProductPurchasingRequest(models.Model):
    ...
    _description = 'Product Purchasing Request'
...
class ProductPurchasingRequestLine(models.Model):
    ...
    _description = "Product Purchasing Request Line"
    ...
    cost_price = fields.Float(string='Cost', required=True, related='product_id.standard_price')
